return {
	...
	config = function(_, opts)
		...
		wk.add({
			...
			{ "<leader>nt", "<cmd>Obsidian today<cr>", desc = "Current Daily" },
			...
			{ "<leader>nT", "<cmd>Obsidian tomorrow<cr>", desc = "Next Daily" },
			...
			{ "<leader>ny", "<cmd>Obsidian yesterday<cr>", desc = "Previous Daily" },
